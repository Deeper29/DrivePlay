...
export const SCENARIOS = {
  reverse: {
    ...
    lessons: [
      {
        title: "观察位置，留出转弯空间",
        text: "初始车头朝右。绿色框是目标车位，先看车尾与车位的相对位置。",
      },
      {
        title: "右打方向，慢慢倒车",
        text: "按 D 右打，再按 S 倒车。车尾向车辆右侧走，车头向左侧摆；注意车头外侧。",
      },
      {
        title: "接近平行，回正入库",
        text: "车身接近车位方向时按 C 回正，继续微调。车身完整入框后，按空格停稳。",
      },
    ],
  },
  parallel: {
    ...
    lessons: [
      {
        title: "与前车并排，留出间距",
        text: "车头朝上，右侧两辆车之间是目标车位。观察两车间距与车尾位置。",
      },
      {
        title: "向右倒入，让车尾进位",
        text: "右打方向并缓慢倒车。车尾靠近右侧路缘，车头向左摆出，留意前后障碍物。",
      },
      {
        title: "反打方向，让车身平行",
        text: "车尾进入车位后左打并继续倒车，让车头收进来。按 C 回正，前后调整并停稳。",
      },
    ],
  },
  free: {
    ...
    lessons: [
      {
        title: "同样的方向，不同的进退",
        text: "先右打方向前进，再保持方向倒车。比较车头朝向与车尾的变化。",
      },
      {
        title: "观察内轮差与转弯圆心",
        text: "打开车轮轨迹和转弯圆心。前后轮不走同一条线，内侧后轮比前轮更靠近圆心。",
      },
      {
        title: "方向回正，不等于车身回正",
        text: "按 C 只会让前轮回正。车身仍保持当前朝向，需要反向转向配合移动才能调整。",
      },
    ],
  },
};
